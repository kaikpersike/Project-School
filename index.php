...
<b>Nome:</b><br>
<input type="text" name="nome" id="texto" required placeholder="Digite aqui..."><br>
<br>

<b>Email:</b><br>
<input type="text" name="email" id="texto" required placeholder="Digite aqui..."><br>
<br>

<b>Senha:</b><br>
<input type="password" name="pass" id="texto" required placeholder="Digite aqui..."><br>
<br>

<b>DDD:</b><br>
( <input type="number" name="num" id="texto" required placeholder="Digite aqui..."> )<br>
<br>

<b>Telefone:</b><br>
<input type="text" name="telefone" id="texto" required placeholder="Digite aqui..."><br>
<br>
